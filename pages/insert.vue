<template>
    <div class="wrap">
        ...
        <div>
            <el-input v-model="listText" type="textarea" :autosize="{ minRows: 5, maxRows: 10 }" placeholder="Please input">
            </el-input>
        </div>
        <div>
...
export default {
    ...
    methods: {
        ...
        onSubmitList() {
            ...
            if (!this.listText || !this.cate || !this.title || !this.maker) return alert('모든 사항을 입력해주세요')
            const params = {
                cate: this.cate,
                title: this.title,
                maker: this.maker,
